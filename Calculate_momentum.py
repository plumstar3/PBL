...
if 'model_df_test' in locals() and 'win_probability_pred' in model_df_test.columns:
    ...
    event_id_to_name_map = {
        ...
        13000: 'ピリオド終了', 18000: 'その他', 1001: 'ジャンプショット成功', 1005: 'レイアップ成功',
        1007: 'ダンク成功', 1041: 'アリウープ成功', 1042: 'ドライビングレイアップ成功',
        1050: 'ランニングダンク成功', 1052: 'アリウープダンク成功', 1055: 'フックショット成功',
        1066: 'ジャンプバンクショット成功', 1108: 'カッティングダンクショット成功', 2001: 'ジャンプショット失敗',
        2005: 'レイアップ失敗', 2007: 'ダンク失敗', 3010: 'フリースロー1本目成功',
        3011: 'フリースロー2本目成功', 3012: 'フリースロー失敗', 5002: 'ボールロスト',
        5004: 'トラベリング/オフェンシブファウル', 5040: 'アウトオブバウンズ', 6001: 'パーソナルファウル',
        6002: 'シューティングファウル', 6003: 'テクニカルファウル'
    }
